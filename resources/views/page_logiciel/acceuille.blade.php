...
<div class="mt-1 mb-1 rounded col-11 retenue mt-1 d-flex p-2" style="margin-left:4em;   background-color: rgb(248, 248, 248)">
    ...
    <div class="col-8 p-2 rounded me-1" style="background:white">
        <div class="d-flex mb-3">
            ...
            <p class="h6" style="color: rgb(17, 126, 17)">Liste de tous les Envois IRSA</p>


            <form action="{{route('recherche')}}" class="d-flex  col-5"  style="margin-left:25% "  method="POST"  name="F">
              <div class=" mt-4">
              ...
              @csrf
                      ...
                      <div class="col-12 mt-3 d-flex align-items-center" style="margin-left: 0.5em">
                        ...
                        <!-- mois input -->
                    <div class="col-2 mt-3 d-flex align-items-center" style="margin-left: -11.2em" >
                      <!-- mensuel input -->
                                  ...
                                  <div class=" d-flex align-items-center">
                                    @if ($l->etat == "en attente" && $l->montant == 0)
                                      <a href="{{route('page_declaration_employer', ["id_dec"=>$l->id] )}}"
                                        ...
                                        <i class=" fa fa-file-archive"></i>&nbsp; Declaration incomplete <br> Continuer la declaration
                                    </a>
        ...
        @if(session('mesi'))
         <p class=" text-success"> <b>{{session('mesi')}}</b> </p>
        @endif
        {{ $liste->links() }}
        ...
        <div class="d d-grid">
              <a href="{{route('acceuille', ["soc"=> session('soc')])}}" class="t text-decoration-none text-dark ">
                <div class="b mb-2 rounded p-2" style="background-color: rgb(226, 226, 226)">
                  ...
                  <small style="font-size: 13px;color:rgb(35, 140, 211)">Tous les listes des declations IRSA envoyer </small>
            ...
            <a href="{{route('declaration',  ["soc"=> session('soc')])}}" class="t text-decoration-none text-dark ">
                <div class="b mb-2 rounded p-2" style="background-color: rgb(245, 245, 245)">
                   ...
                   <small style="font-size: 13px;color:rgb(35, 140, 211)">permet d'envoyer et declarer puis payer vos IRSA</small>

                </div>
            </a>
            <a href="{{route('recap',  ["soc"=> session('soc')])}}" class="t text-decoration-none text-dark ">
                <div class="b mb-2 rounded p-2" style="background-color: rgb(245, 245, 245)">
                   <i class="fa fa-envelope-open-text"></i> Recapitulation des Envoie IRSA <br>
                   <small style="font-size: 13px;color:rgb(35, 140, 211)">pour visualiser les declaration l'IRSA a envoyer et recuperer le recepissé </small>
            ...
            <a href="{{route('liste_paiment', ["soc"=> session('soc')])}}" class="t text-decoration-none text-dark ">
              <div class="b mb-2 rounded p-2" style="background-color: rgb(245, 245, 245)">
                 ...
                 <small style="font-size: 13px;color:rgb(35, 140, 211)">liste des paiements  </small>
