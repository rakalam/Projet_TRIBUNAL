...
<div class="d-flex align-items-center p-3 rounded col-11 tete">
    <div class="lh-1">
      <h1 class="h5 mb-0 lh-1"><b><b>Payment d' IRSA</b></b></h1>
...
<div class="mt-1 mb-1 rounded col-11 retenue mt-1 d-flex p-2" style="margin-left:4em; 
    ...
    <div class="col-8 p-2 rounded me-1" style="background:white">
          <div class="page1">
            <p class="h3" style="color: rgb(17, 126, 17)"> Télépaiment </p>

            <div class=" rounded p-2 mt-2 bg-body-tertiary">
                      <p class="h5">Instruction</p>
                     1- Confirmer la valeur du champ <b>"montant à payer"</b> dans le champs <b>"montant payer"</b> <br>
                     2-Cliquer sur <b>"creer un virment banquaire"</b>
            </div>

          

                    <div class=" text-danger mt-1" id="message">
                        <p> 
                          <b>{{-- $message_penalite --}}</b>
            ...
            <div class=" mt-3" style="border: 3px solid rgb(243, 243, 243)">
                 ...
                 <table class="table " style="font-size: 12px">
                   ...
                   <tbody >
                               ...
                               <tr>
                                   ...
                                   <td>
                                     <form action="" name="F">
                                      <input style="border: none" type="text" name="mt" placeholder="0" class=" w-75 bg-body-secondary rounded p-1" > Ar
             ...
             <div class="allez_p2">
                  <div class=" btn btn mt-3" style=" background:rgb(17, 126, 17);color:white; margin-left:67%">
                    <i class=" fa fa-bank"> </i> &nbsp; creer un virment banquaire
                </div>
             </div>
          ...
          <div class="page2" style="display: none">
            <div class="allez_p1" style="margin-left:45% ">
              <div class=" btn btn-sm mt-3" style=" background:rgb(17, 126, 17);color:white; margin-left:78%">
            ...
            <div class=" p-2">
              ...
              <!--Information payeur -->
                ...
                <form action="{{ route('ajout_paiment')}}" method="post" class=" form p-2" style="font-size: 13px">
                        ...
                        <input type="hidden"  required name="id_entreprise" style="border: none" value="{{$declaration->id_entreprise}}" />
                            ...
                            <div class="col-12 mt-3 d-flex align-items-center" id="in1">
                              ...
                              <input type="date" required name="date_paiment"  class=" form-control w-75" />
                            </div>
              ...
              <!--Information  Beneficiaire -->
                      ...
                      <button  style="background-color:rgb(177, 19, 19);
                                                            color:white ;
                                                            border:none;
                                                            padding-left:1.2em; 
                                                            padding-right:1.2em;
                                    ...
                                    class=" mt-4">
                                    <a href="{{route('acceuille', ["soc"=>session('soc')])}}" style="text-decoration: none; color:white">  <i class="fa fa-close"></i>
                                      &nbsp; Annuler</a>
                      </button>
